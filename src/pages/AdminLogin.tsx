...
export default function AdminLogin() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('https://contabilfacil-api.onrender.com/api/admin/login', {
                method: 'POST',
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h2 style={{ textAlign: 'center', marginBottom: '0.5rem', color: 'var(--primary)' }}>ContabilFácil</h2>
                <p style={{ textAlign: 'center', marginBottom: '1.5rem', color: 'var(--text-muted)' }}>Acesso Administrativo</p>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ marginTop: '1rem', textAlign: 'center' }}>
                        <a href="/portal/login" style={{ color: 'var(--secondary)', fontSize: '0.9rem', textDecoration: 'none' }}>
                            Sou um Escritório (Acessar Portal)
                        </a>
                    </div>
                </form>
            </div>
